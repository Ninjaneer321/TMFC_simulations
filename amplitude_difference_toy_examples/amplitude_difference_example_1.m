...
subplot(133); imagesc(mean(amp_diff1,3)); title('Amplitude differences'); axis square; caxis([-1 1]); set(gca,'XTick',[1 15 30], 'YTick', [1 15 30]); colorbar
try
...
subplot(133); imagesc(mean(amp_diff2,3)); title('Amplitude differences'); axis square; caxis([-1 1]); set(gca,'XTick',[1 15 30], 'YTick', [1 15 30]); colorbar
try
    sgtitle('With amplitude differences')
catch
    suptitle('With amplitude differences')
end
try
    colormap('turbo')
catch
