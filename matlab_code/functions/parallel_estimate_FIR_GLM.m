function parallel_estimate_FIR_GLM(stat_path,sots_path,exp_folder,N,TR,model,FIR_window,FIR_bins)
...
for subji = 1:N
    matlabbatch{1}.spm.stats.fmri_spec.dir = ...
        {[stat_path filesep exp_folder filesep 'FIR_GLMs' filesep 'Sub_' num2str(subji,'%.3d')]};
    ...
    matlabbatch{1}.spm.stats.fmri_spec.bases.fir.length = FIR_window;
    matlabbatch{1}.spm.stats.fmri_spec.bases.fir.order = FIR_bins;
