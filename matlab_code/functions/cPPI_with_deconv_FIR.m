function cPPI_with_deconv_FIR(stat_path,exp_folder,N,N_ROIs,q_level,ground_truth)
...
for subji = 1:N
    ...
    save([stat_path filesep exp_folder filesep 'GLMs' filesep 'Sub_' num2str(subji,'%.3d') filesep 'cPPI_with_Deconv_FIR.mat'],'partcorr_TaskA_vs_TaskB_cPPI');
    time(subji)=toc;
...
for subji = 1:N
    load([stat_path filesep exp_folder filesep 'GLMs' filesep 'Sub_' num2str(subji,'%.3d') filesep 'cPPI_with_Deconv_FIR.mat']);
    cPPI_WD_TaskA_vs_TaskB(:,:,subji) = partcorr_TaskA_vs_TaskB_cPPI; 
end
save([stat_path filesep exp_folder filesep 'group_stat' filesep 'cPPI_with_Deconv_FIR.mat'],'cPPI*');
time = toc;
...
%% Save results
save([stat_path filesep exp_folder filesep 'group_stat' filesep 'cPPI_with_Deconv_FIR_RESULTS.mat'],'TPR*','TNR*');
