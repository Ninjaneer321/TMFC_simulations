function corrdiff(stat_path,sots_path,exp_folder,N,TR,q_level,ground_truth)
...
tic
load(sots_path);
load([stat_path filesep exp_folder filesep 'GLMs' filesep 'Sub_' num2str(1,'%.3d') filesep  'VOI_ALL.mat']);
...
for subji = 1:N
    ...
    save([stat_path filesep exp_folder filesep 'GLMs' filesep 'Sub_' num2str(subji,'%.3d') filesep 'CorrDiff.mat'],'corr_*');       
...
for subji = 1:N
    load([stat_path filesep exp_folder filesep 'GLMs' filesep 'Sub_' num2str(subji,'%.3d') filesep 'CorrDiff.mat']);
...
save([stat_path filesep exp_folder filesep 'group_stat' filesep 'CorrDiff.mat'],'corrdiff*');
time = toc;
...
%% Save results
save([stat_path filesep exp_folder filesep 'group_stat' filesep 'CorrDiff_RESULTS.mat'],'TPR*','TNR*');
