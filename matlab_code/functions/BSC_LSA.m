function BSC_LSA(stat_path,sots_path,exp_folder,N,TR,model,q_level,ground_truth)
...
for subji = 1:N
    ...
    save([stat_path filesep exp_folder filesep 'GLMs' filesep 'Sub_' num2str(subji,'%.3d') filesep 'BSC_LSA.mat'],'BSC*','betas_LSA');
    clear BSC* betas_LSA
...
for subji = 1:N
    load([stat_path filesep exp_folder filesep 'GLMs' filesep 'Sub_' num2str(subji,'%.3d') filesep 'BSC_LSA.mat']);
...
save([stat_path filesep exp_folder filesep 'group_stat' filesep 'BSC_LSA.mat'],'BSC*');
time = toc;
...
%% Save results
save([stat_path filesep exp_folder filesep 'group_stat' filesep 'BSC_LSA_RESULTS.mat'],'TPR*','TNR*');